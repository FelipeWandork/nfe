	...
	*/
	...
	public function verificarParametrosNFe(){
		...
		if($st_empresa && $st_pdv && $st_md5){
			...
			$data 		= $data." 00:00:00";
			$data_aut	= $data_aut." ".$hora_aut;
			$r = $bd->inserirXml($tabela, $codigo_empresa, $numero_nota, $codigo_pdv, $cpf_cnpj,$tipo,$data,$hora_aut,$valor,$cancelado,$doc_original,$nome_xml, $xml, $data_aut, $chave_nf);
			return $r;
		}
	}
